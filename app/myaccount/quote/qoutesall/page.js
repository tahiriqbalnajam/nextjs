							...
							<div className="services-quote mt-5 pt-5">
								...
								<div className="services-quote-box">
									...
									<div className="list-quotes-header">
										...
										<MyLink href="/myaccount/quote/qoutesall" className="active">Todos <span>5</span></MyLink>
									</div>
										...
										<table className="w-full max-w-full mb-4 bg-transparent default-table">
											...
											<tbody>
												<tr>
													...
													<td className="text-end"><MyLink href="/myaccount/quote/qoutesall/allservicetomail" className="view-btn"><i className="fa-solid fa-eye"></i></MyLink></td>
												</tr>
												<tr>
													<td>Boda</td>
												...
												<tr>
													...
													<td>Cancelada</td>
													<td className="text-end"><MyLink href="/myaccount/quote/qoutesall" className="view-btn"><i className="fa-solid fa-eye"></i></MyLink></td>
												</tr>
												<tr>
