                    ...
                    <div className="search-wrapp">
                        <div className="search-box">
                            <div className="flex flex-wrap  g-0">
                                ...
                                <MainPageAllDropdowns toggletext={wheretoggletext} heading="Dónde" firstitem="Todo México" customclassName="whereclass"/>

                                <MainPageAllDropdowns toggletext={pricetoggletext} heading="Precio" firstitem="$0 - $5,000" customclassName="priceclass"/>
                            </div>
                        </div>
