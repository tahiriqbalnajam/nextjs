...
function loadHtml5LightBox(jsFolder) {
        ...
        $.fn.html5lightbox = function(options) {
            ...
            inst.readData = function() {
                inst.each(function() {
                    if (this.nodeName.toLowerCase() !=
                        "Link" && this.nodeName.toLowerCase() != "area") return;
                    var $this = $(this);
            ...
            inst.createMarkup = function() {
                ...
                inst.$lightbox =
                    jQuery("<div id='html5-lightbox' style='display:none;top:0px;left:0px;width:100%;height:100%;z-index:9999998;text-align:center;'>" + "<div id='html5-lightbox-overlay' style='display:block;position:absolute;top:0px;left:0px;width:100%;min-height:100%;background-color:" + inst.options.overlaybgcolor + ";opacity:" + inst.options.overlayopacity + ";filter:alpha(opacity=" + Math.round(inst.options.overlayopacity * 100) + ");'></div>" + "<div id='html5-lightbox-box' style='display:block;position:relative;margin:0px auto;'>" +
                        ...
                        inst.options.skinsfolder + inst.options.loadingimage + "\") no-repeat center center;'></div>" + "<div id='html5-error' className='html5-error' style='display:none;position:absolute;padding:" + inst.options.bordersize + "px;text-align:center;width:" + inst.options.errorwidth + "px;height:" + inst.options.errorheight + "px;'>" + "The requested content cannot be loaded.<br />Please try again later." + "</div>" + "<div id='html5-image' style='display:none;position:absolute;top:0px;left:0px;" + (inst.options.iequirksmode ? "margin" :
                            "padding") + ":" + inst.options.bordersize + "px;text-align:center;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;'></div>" + "<div id='html5-next' style='display:none;cursor:pointer;position:absolute;right:" + inst.options.bordersize + "px;top:50%;margin-top:-16px;'><Image src='" + inst.options.skinsfolder + inst.options.nextimage + "'></div>" + "<div id='html5-prev' style='display:none;cursor:pointer;position:absolute;left:" + inst.options.bordersize + "px;top:50%;margin-top:-16px;'><Image src='" +
                ...
                inst.$lightboxBox.append("<div id='html5-close' style='display:none;cursor:pointer;position:absolute;top:0;right:0;margin-top:-16px;margin-right:-16px;'><Image src='" + inst.options.skinsfolder + inst.options.closeimage + "'></div>");
                inst.$close = $("#html5-close",
                    inst.$lightbox);
                inst.$watermark = $("#html5-watermark", inst.$lightbox);
                if (inst.options.stamp) inst.$watermark.html("<Link href='" + inst.options.freelink + "' style='text-decoration:none;' title='jQuery Lightbox'><div style='display:block;width:170px;height:20px;text-align:center;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;background-color:#fff;color:#333;font:12px Arial,sans-serif;'><div style='line-height:20px;'>" + inst.options.freemark + "</div></div></Link>");
                else if (inst.options.watermark) {
                    var html =
                        "<Image src='" + inst.options.watermark + "' style='border:none;' />";
                    if (inst.options.watermarklink) html = "<Link href='" + inst.options.watermarklink + "' target='_blank'>" + html + "</Link>";
            ...
            inst.loadThumbnail = function(src, index) {
                ...
                $(imgLoader).load(function() {
                    ...
                    $(".html5-nav-thumb").eq(index).html("<Image style='" + style + "' src='" + src + "' />")
                });
                imgLoader.src = src
            };
            inst.showNavigation = function() {
                ...
                $("body").append("<div className='html5-nav' style='display:block;position:fixed;bottom:0;left:0;width:100%;height:" +
                    inst.options.navheight + "px;z-index:9999999;'>" + "<div className='html5-nav-container' style='position:relative;margin:" + inst.options.thumbtopmargin + "px auto " + inst.options.thumbbottommargin + "px;'>" + "<div className='html5-nav-prev' style='display:block;position:absolute;cursor:pointer;width:" + inst.options.navbuttonwidth + 'px;height:100%;left:0;top:0;background:url("' + inst.options.skinsfolder + inst.options.navarrowsprevimage + "\") no-repeat left center;'></div>" + "<div className='html5-nav-mask' style='display:block;position:relative;margin:0 auto;overflow:hidden;'>" +
                    "<div className='html5-nav-list'></div>" + "</div>" + "<div className='html5-nav-next' style='display:block;position:absolute;cursor:pointer;width:" + inst.options.navbuttonwidth + 'px;height:100%;right:0;top:0;background:url("' + inst.options.skinsfolder + inst.options.navarrowsnextimage + "\") no-repeat right center;'></div>" + "</div>" + "</div>");
                var index = 0;
                for (i = 0; i < inst.elemArray.length; i++)
                    if (group == inst.elemArray[i][ELEM_GROUP])
                        if (inst.elemArray[i][ELEM_THUMBNAIL] && inst.elemArray[i][ELEM_THUMBNAIL].length > 0) {
                            $(".html5-nav-list").append("<div className='html5-nav-thumb' data-arrayindex='" +
            ...
            inst.showTitle = function(w, t, description) {
                ...
                if (inst.options.showdescription && description && description.length > 0) text += '<p className="html5-description">' + description + "</p>";
                inst.$text.html(text)
                ...
                inst.resizeLightbox(sizeObj.w,
                    ...
                    function() {
                        ...
                        inst.$image.html("<Image src='" + elem[ELEM_HREF] + "' width='100%' height='100%' />");
                        inst.$elem.fadeIn(inst.options.fadespeed, function() {
                            inst.showData()
                        })
                    })
            ...
            inst.prepareDailymotionHref = function(href) {
                if (href.match(/\:\/\/.*(dai\.ly)/i)) {
                    ...
                    var id = href.match(/(dai\.ly\/)([Link-zA-Z0-9\-\_]+)/)[2];
            ...
            inst.embedFlash = function($container, src, wmode, flashVars) {
                if (inst.options.flashInstalled) {
                    ...
                    $container.html("<embed " +
                        htmlString + "/>")
                } else $container.html("<div className='html5lightbox-flash-error' style='display:block; position:relative;text-align:center; width:100%; left:0px; top:40%;'><div className='html5-error'><div>The required Adobe Flash Player plugin is not installed</div><br /><div style='display:block;position:relative;text-align:center;width:112px;height:33px;margin:0px auto;'><Link href='http://www.adobe.com/go/getflashplayer'><Image src='http://www.adobe.com/images/shared/download_buttons/get_flash_player.gif' alt='Get Adobe Flash player' width='112' height='33'></Image></Link></div></div>")
            };
    ...
    (function($) {
        $.fn.lightboxHTML5VideoControls = function(skinFolder, parentInst, hidecontrols, hideplaybutton) {
            ...
            var $videoPlay = $("<div className='html5boxVideoPlay'></div>");
            if (!isIPhone) {
            ...
            var $videoFullscreenBg = $("<div className='html5boxVideoFullscreenBg'></div>");
            var $videoControls = $("<div className='html5boxVideoControls'>" +
                "<div className='html5boxVideoControlsBg'></div>" + "<div className='html5boxPlayPause'>" + "<div className='html5boxPlay'></div>" + "<div className='html5boxPause'></div>" + "</div>" + "<div className='html5boxTimeCurrent'>--:--</div>" + "<div className='html5boxFullscreen'></div>" + "<div className='html5boxHD'></div>" + "<div className='html5boxVolume'>" + "<div className='html5boxVolumeButton'></div>" + "<div className='html5boxVolumeBar'>" + "<div className='html5boxVolumeBarBg'>" + "<div className='html5boxVolumeBarActive'></div>" + "</div>" + "</div>" + "</div>" + "<div className='html5boxTimeTotal'>--:--</div>" +
                "<div className='html5boxSeeker'>" + "<div className='html5boxSeekerBuffer'></div>" + "<div className='html5boxSeekerPlay'></div>" + "<div className='html5boxSeekerHandler'></div>" + "</div>" + "<div style='clear:both;'></div>" + "</div>");
